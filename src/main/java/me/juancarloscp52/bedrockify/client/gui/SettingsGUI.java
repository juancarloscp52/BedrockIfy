...
public class SettingsGUI {
    ...
    public Screen getConfigScreen(Screen parent, boolean isTransparent){
        ...
        guiImprovements.add(entryBuilder.startBooleanToggle(new TranslatableText("bedrockify.options.biggerItems"), settings.biggerIcons).setDefaultValue(true).setSaveConsumer(newValue -> settings.biggerIcons=newValue).build());
        guiImprovements.add(entryBuilder.startBooleanToggle(new TranslatableText("bedrockify.options.transparentToolBar"), settings.transparentHotBar).setDefaultValue(true).setSaveConsumer(newValue -> settings.transparentHotBar=newValue).build());
        ...
        guiImprovements.add(entryBuilder.startBooleanToggle(new TranslatableText("bedrockify.options.bedrockShading"), settings.bedrockShading).setDefaultValue(true).setSaveConsumer(newValue -> {
        ...
        otherSettings.add(entryBuilder.startBooleanToggle(new TranslatableText("bedrockify.options.rotationalBackground.old"), settings.oldPanoramaMode).setDefaultValue(false).setTooltip(wrapLines(new TranslatableText("bedrockify.options.rotationalBackground.old.tooltip"))).setSaveConsumer(newValue -> settings.oldPanoramaMode=newValue).build());
