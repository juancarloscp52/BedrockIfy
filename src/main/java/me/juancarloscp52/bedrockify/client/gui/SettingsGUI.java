...
public class SettingsGUI {
    ...
    public Screen getConfigScreen(Screen parent, boolean isTransparent){
        ...
        otherSettings.add(entryBuilder.startBooleanToggle(Text.translatable("bedrockify.options.quickArmorSwap"), settingsClient.quickArmorSwap).setDefaultValue(true).setSaveConsumer(newValue -> settingsClient.quickArmorSwap=newValue).build());
