...
public class DyingTrees {
    ...
    private static void registerDyingTrees (){
        ...
        PlacedFeature PLACED_DYING_BIRCH_TREE = DYING_BIRCH_TREE.withPlacement(VegetationPlacedFeatures.modifiersWithWouldSurvive(PlacedFeatures.createCountExtraModifier(0, 0.25f, 2), Blocks.BIRCH_SAPLING));
        PlacedFeature PLACED_DYING_OAK_TREE = DYING_OAK_TREE.withPlacement(VegetationPlacedFeatures.modifiersWithWouldSurvive(PlacedFeatures.createCountExtraModifier(1, 0.1f, 0), Blocks.OAK_SAPLING));
        PlacedFeature PLACED_DYING_OAK_TREE_PLAINS = DYING_OAK_TREE.withPlacement(VegetationPlacedFeatures.modifiersWithWouldSurvive(PlacedFeatures.createCountExtraModifier(0, 0.01f, 1), Blocks.OAK_SAPLING));
        PlacedFeature PLACED_DYING_SPRUCE_TREE = DYING_SPRUCE_TREE.withPlacement(VegetationPlacedFeatures.modifiersWithWouldSurvive(PlacedFeatures.createCountExtraModifier(1, 0.1f, 0), Blocks.SPRUCE_SAPLING));
        PlacedFeature PLACED_DYING_PINE_TREE = DYING_PINE_TREE.withPlacement(VegetationPlacedFeatures.modifiersWithWouldSurvive(PlacedFeatures.createCountExtraModifier(1, 0.1f, 0), Blocks.SPRUCE_SAPLING));
        PlacedFeature PLACED_DYING_DARK_OAK_TREE = DYING_DARK_OAK_TREE.withPlacement(VegetationPlacedFeatures.modifiersWithWouldSurvive(PlacedFeatures.createCountExtraModifier(1, 0.1f, 0), Blocks.DARK_OAK_SAPLING));
    ...
    private static void registerFallenTrees(){
        ...
        PlacedFeature PLACED_FALLEN_OAK_TREE = FALLEN_OAK_TREE_CONFIGURED.withPlacement(VegetationPlacedFeatures.modifiersWithWouldSurvive(PlacedFeatures.createCountExtraModifier(0, 0.1f, 1), Blocks.OAK_SAPLING));
        PlacedFeature PLACED_FALLEN_OAK_TREE_PLAINS = FALLEN_OAK_TREE_CONFIGURED.withPlacement(VegetationPlacedFeatures.modifiersWithWouldSurvive(PlacedFeatures.createCountExtraModifier(0, 0.01f, 1), Blocks.OAK_SAPLING));
        PlacedFeature PLACED_FALLEN_BIRCH_TREE = FALLEN_BIRCH_TREE_CONFIGURED.withPlacement(VegetationPlacedFeatures.modifiersWithWouldSurvive(PlacedFeatures.createCountExtraModifier(0, 0.1f, 1), Blocks.BIRCH_SAPLING));
        PlacedFeature PLACED_FALLEN_SPRUCE_TREE = FALLEN_SPRUCE_TREE_CONFIGURED.withPlacement(VegetationPlacedFeatures.modifiersWithWouldSurvive(PlacedFeatures.createCountExtraModifier(0, 0.2f, 1), Blocks.SPRUCE_SAPLING));
